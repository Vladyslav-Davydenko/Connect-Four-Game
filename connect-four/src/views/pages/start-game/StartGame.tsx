  ...
  return (
    <div className="flex-col">
      ...
      <div className=" flex flex-col gap-5 text-center text-xl">
        ...
        <Link
          to={"test"}
          className="py-3 mx-16 bg-white text-blue border rounded-lg hover:-translate-y-1 active:translate-y-1.5 duration-500 shadow-lg hover:shadow-xl active:shadow-md animate-appear_4 fill-mode-backwards"
        >
          Error Test
        </Link>
