...
export function DeletePopUp({ id, setIsOpen }: Props): JSX.Element {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        className={` bg-primary md:p-10 p-6 rounded-xl shadow-lg z-20 opacity-0 animate-appear_3 fill-mode-forwards flex flex-col justify-center items-center gap-10`}
      >
